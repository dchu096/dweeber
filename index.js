...
bot.on('guildMemberAdd', async member => {
    ...
    let welcomeEmbed = new Discord.MessageEmbed()
        ...
        .addField("Rules:", "We have our server rules at <#790489245193732127> to maintain behaviour in server, please read so you dont break them!", false)
        .addField("Roles:", " A lot of channels in this server require a role to be assigned. get to <#786798319992307763> to get yourself some!", false)
