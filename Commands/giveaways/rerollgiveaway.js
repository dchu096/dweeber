...
module.exports = {
    ...
    run: async(client, interaction, args) => {
        ...
        const nopermsEmbed = new MessageEmbed()
            .setColor('#ff0000')
            .setTitle('Error')
            .setDescription('You do not have the permissions to reroll a giveaway. [Required Permissions: MANAGE_MESSAGES]')
            .addFields(
        ...
        try {
            ...
            const endEmbed = new MessageEmbed()
                .setColor('RANDOM')
                .setTitle('Success')
                .setDescription('The giveaway has been rerolled.')
                .setFooter('Dweeber >> endgiveaway');
