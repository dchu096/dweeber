...
module.exports = client => {
    ...
    https.createServer(
      {
        key: fs.readFileSync("./dashboard/privkey.pem"),
        cert: fs.readFileSync("./dashboard/fullchain.pem"),
      },
      app).listen(8443, () => {
        console.log(`[${settings.website.domain}]: dashboard loaded on port 8443`)
    });
}
